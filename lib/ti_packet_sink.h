#ifndef TI_PACKET_SYNC
#define TI_PACKET_SYNC

#include <gr_sync_block.h>
#include <gr_msg_queue.h>

class ti_packet_sink;

typedef boost::shared_ptr<ti_packet_sink> ti_packet_sink_sptr;

ti_packet_sink_sptr make_ti_packet_sink (const std::vector<unsigned char>& sync_vector,
			   gr_msg_queue_sptr target_queue);

class ti_packet_sink : public gr_sync_block
{
private:
 	friend ti_packet_sink_sptr make_ti_packet_sink (const std::vector<unsigned char>& sync_vector,
			   gr_msg_queue_sptr target_queue);	
 	
 	ti_packet_sink();   // private constructor	
...
protected:
 	ti_packet_sink(const std::vector<unsigned char>& sync_vector, 
		       gr_msg_queue_sptr target_queue,
		       int threshold);
 ...
 public:
 	~ti_packet_sink ();  // public destructor	
